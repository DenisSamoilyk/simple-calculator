        ...
        # Calculator
            while True:
                ...
                # Result
                    ...
                    print("▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣")
                # Continue?
                    ask_question = input("Do you want continue?\nYes/No\n")
                    L_ask_question = ask_question.lower()
                    if L_ask_question == "yes" or L_ask_question == "ye" or L_ask_question == "y":
                        continue
                    elif L_ask_question == "no" or L_ask_question == "n":
                        print("▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣▣")
                        break
                    else:
                        print("|◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢|")
                        print(" You write something wrong, so we continue")
                        print("|◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢|")
...
# Possible Errors
        ...
        print("|◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢|")
        print( f"Something went wrong: {write}")
        print("|◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢◤◢|")
